...
public class MultiToolRegistryExample {
        public static void main(String[] args) throws Exception {
                ...
                OllamaResult res = ollamaAPI
                                .generate(OllamaGenerateRequestBuilder.builder().withModel(model)
                                                .withPrompt("What is the petrol price in Bengaluru?").build(), null);
                System.out.println(res.getResponse());

                // // Use the weather tool specifications in the prompt
                // for (OllamaToolsResult.ToolResult r : ollamaAPI
                // .generateWithTools(
                // model,
                // new Tools.PromptBuilder()
                ...
                OllamaResult res3 = ollamaAPI
                                .generate(OllamaGenerateRequestBuilder.builder().withModel(model)
                                                ...
                                                .build(), null);
                System.out.println(res3.getResponse());
        }
}
