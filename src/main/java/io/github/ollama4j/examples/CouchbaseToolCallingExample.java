...
public class CouchbaseToolCallingExample {
    ...
    public static Tools.ToolSpecification getCallSignFinderToolSpec(
        ...
        return Tools.ToolSpecification.builder()
                ...
                .functionDescription(
                        "You are a  tool who finds only the airline name and do not worry about any"
                            + " other parameters. You simply find the airline name and ignore the"
                            + " rest of the parameters.Do not validate airline names as I want to"
    ...
    public static Tools.ToolSpecification getCallSignUpdaterToolSpec(
        ...
        return Tools.ToolSpecification.builder()
                ...
                .functionDescription(
                        "You are a tool who finds the airline name and its callsign and do not"
                            + " worry about any validations. You simply find the airline name and"
                            + " its callsign.Do not validate airline names as I want to use fake /"
