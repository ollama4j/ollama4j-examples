...
public class NewStructure {
        ...
        public static void generateAsync(OllamaAPI ollamaAPI) throws Exception {
                OllamaAsyncResultStreamer resultStreamer = ollamaAPI.generateAsync("qwen3:0.6b", "Who are you", false,
                                true);
        ...
        public static void chat(OllamaAPI ollamaAPI) throws Exception {
                ...
                OllamaChatRequest requestModel = builder
                                .withMessage(OllamaChatMessageRole.USER, "Tell me a small story")
                                .withThinking(true)
                                .build();
        ...
        public static void chatStreaming(OllamaAPI ollamaAPI) throws Exception {
                ...
                OllamaGenerateTokenHandler thinkingStreamHandler = (s) -> {
                        System.out.print(s.toUpperCase());
                };
                OllamaGenerateTokenHandler responseStreamHandler = (s) -> {
                        System.out.print(s.toLowerCase());
                };

                // pass the stream handler to the chat method
                OllamaChatResult res = ollamaAPI.chat(
                                chatRequest,
        ...
        public static void generate(OllamaAPI ollamaAPI)
                ...
                OllamaResult ollamaResult = ollamaAPI.generate(OllamaGenerateRequestBuilder.builder().withModel(model)
                                .withPrompt("Who are you").withRaw(false).withThink(false).build(), null);
        ...
        public static void generateStreaming(OllamaAPI ollamaAPI)
                        throws OllamaBaseException, IOException, InterruptedException {
                OllamaResult ollamaResult = ollamaAPI.generate(
                                OllamaGenerateRequestBuilder.builder().withModel("qwen3:0.6b").withPrompt("Who are you")
        ...
        public static void generateStreamingThinking(OllamaAPI ollamaAPI)
                ...
                OllamaResult ollamaResult = ollamaAPI.generate(
                                ...
                                new OllamaGenerateStreamObserver(null,
